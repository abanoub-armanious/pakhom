...
- **Reflexive scaffold (Mode 1).** An AI "provocateur" interrogates the
  ...
  memo trail. For researchers who hold that interpretation must stay human.
...
- **Quote provenance.** Every AI-attributed quote passes a four-step
  verification ladder against the source text; fabricated or drifted quotes are
  dropped and logged, never rendered. (This stance is motivated by Jowsey et al.
  2025, the "Frankenstein" finding on generative-AI quote fabrication in
  qualitative work.)
...
co-occurrence network; longitudinal theme-emergence views; a research-question
...
- **QDA-software interoperability.** QDPX export in the REFI-QDA
  project-exchange format (`urn:QDA-XML:project:1.0`) for import into NVivo,
  ATLAS.ti, and MAXQDA.

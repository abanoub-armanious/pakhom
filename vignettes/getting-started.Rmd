...
6. **Multi-pass AI theme generation** (Phase 60, the `v2` default) -- the AI
   ...
   pass *after* the grouping converges. (The earlier Phase 52 HAC-on-embeddings
   tree-walk has been removed; v2 is the only theme-generation engine.)
...
analysis:
  ...
  themes:
    ...
    max_subtheme_depth: 3         # inert: only the removed v1 HAC walker read this
    max_codes_per_subtheme: 25    # inert: only the removed v1 HAC walker read this

...
This opens a step-by-step web interface in your browser where you can fill in
every setting with descriptions, validation, and live YAML preview. When done,
it saves the file. Requires the `shiny` package (`install.packages("shiny")`).
...
> pakhom: AI-Assisted Reflexive Thematic Analysis with

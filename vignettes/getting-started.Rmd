...
6. **Iterative bottom-up theme generation** -- Codes are merged in multiple
   passes until no more productive groupings exist. Themes and subthemes
   emerge organically from the merge depth
...
> pakhom: AI-Integrated Thematic Analysis Following

...
#    columns indicate which entries support each theme.
my_corpus <- tibble::tibble(
  std_id = paste0("e", 1:N),
  std_text = c(...),
  std_author = c(...),  # T0.2 participant spread
  theme_membership_Adherence  = c(1, 1, 0, ...),
  theme_membership_Resistance = c(0, 0, 1, ...)
)

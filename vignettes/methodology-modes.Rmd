...
AI clustering with label-after-clustering, targeting 4-10 themes for
corpora of this size. The narrative above describes a v1 run; under v2,
the medication × sleep findings should surface as their own theme rather
than vanishing in 417 single-code buckets. Whether v2 actually delivers
this is the subject of Phase 60.8 empirical re-validation.)

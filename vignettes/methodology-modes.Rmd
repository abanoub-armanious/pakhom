...
my_corpus <- tibble::tibble(
  ...
  std_text = c(
    ...
    "My manager encouraged the team to try no-meeting mornings.",
    "My team keeps booking back-to-back calls, so async never took hold.",
...
Mode 2, a secondary facet you named in your research focus (say, "meeting
load" within a broad remote-work study) may not surface as its own
theme: the codes that express it can legitimately disperse across the other
themes where they cohere more strongly. That is sound emergent
...
What each pipeline step transmits to the AI provider, and what a finished
run directory contains on disk, is documented in `vignette("data-flow")`.
